...
$sql = "SELECT empresas.RUT as RutEmpresa,COUNT(titularempesa.CI) as CantidadTitulares FROM empresas INNER JOIN titularempesa
ON titularempesa.RUT=empresas.RUT
GROUP BY empresas.RUT;";
