...
$sql = "SELECT pagosimpuestos.NumeroFormulario AS CodigoImpuesto,SUM(pagosimpuestos.monto) as TotalRecaudado FROM pagosimpuestos GROUP BY pagosimpuestos.NumeroFormulario 
ORDER BY TotalRecaudado DESC LIMIT 3";
