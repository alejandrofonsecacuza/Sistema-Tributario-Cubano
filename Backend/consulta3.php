...
$sql = "SELECT personasnaturales.RUT,personas.CI,personas.nombre FROM personas
INNER JOIN personasnaturales
ON personas.CI=personasnaturales.CI INNER JOIN pagosimpuestos ON pagosimpuestos.RUT=personasnaturales.RUT
INNER JOIN localespago ON pagosimpuestos.CodEntidad=localespago.CodEntidad GROUP BY personasnaturales.RUT,personas.CI,personas.nombre
HAVING COUNT(*) = (SELECT COUNT(*) FROM pagosimpuestos WHERE pagosimpuestos.RUT=personasnaturales.RUT);
";
