...
$sql = "SELECT empresas.RUT, SUM(pagosimpuestos.monto)  as SumaDinero FROM empresas INNER JOIN pagosimpuestos ON empresas.RUT=pagosimpuestos.RUT
WHERE pagosimpuestos.fechaPago BETWEEN '2024-02-12' AND '2024-02-16';
";
